    ...
    return (
        <div className={styles.container} >
            ...
            <pre>
                {`
제1조 (목적)
본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 주식회사 하이퍼로컬 (이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.
제2조 (약관의 효력 및 변경)
...
A.종류 : 동네 반려동물 친구 찾기앱
B.서비스명 : 38도
C.설명 : 다른 이용자 사이의 반려동물을 키우는 사용자끼리 위치기반에 가까운 동네에서 친구를 찬는 서비스
D.위치정보 이용 목적: 친구 요청 및 수행 시 위치 확인, 게시물 작성 및 정보 제공시 위치 확인
E.이용 요금 : 무료
제6조 (서비스 이용요금)
...
A.법령의 규정에 의거하거나 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우
...
B.회원이 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우
제10조 (개인위치정보주체의 권리)
...
회사는 아래의 경우에 해당하는 자(이하 “8세 이하의 아동 등”)의 위치정보 보호 및 이용 등에 관한 법률 제26조 제2항에 해당하는 자(이하 “보호의무자”)가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 간주합니다.[4]
A.8세 이하의 아동
B.피성년후견인
C.장애인복지법 제2조 제2항 제2호의 규정에 따른 정신적 장애를 가진 자로서 장애인 고용촉진 및 직업재활법 제2조 제2호의 규정에 따라 중증장애인에 해당하는 자(장애인복지법 제32조의 규정에 따라 장애인등록을 한 자에 한합니다)
전항의 규정에 따른 8세 이하 아동 등의 보호의무자는 해당 아동을 사실상 보호하는 자로서 다음 각 호에 해당하는 자를 말합니다.
A.8세 이하의 아동의 법정대리인 또는 보호시설에 있는 미성년자의 후견 직무에 관한 법률 제3조의 규정에 따른 후견인
B.피성년후견인의 법정대리인
C.본 조 제1항 제3호의 자의 법정대리인 또는 장애인복지법 제58조 제1항 제1호의 규정에 따른 장애인생활시설(국가 또는 지방자치단체가 설치·운영하는 시설에 한합니다)의 장, 정신보건법 제3조 제4호의 규정에 따른 정신질환자 사회복귀시설(국가 또는 지방자치단체가 설치·운영하는 시설에 한합니다)의 장, 동법 동조 제5호의 규정에 따른 정신요양시설의 장
...
A.상호 : 딥스펀지 주식회사
B.대표 : 홍성욱
C.주소 : 서울특별시 봉은사로 129-1 7층 702-ㅡMS17호
D.대표전화 : 010-4739-0704
E.회사는 개인위치정보를 적절히 관리·보호하고, 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 있는 자를 위치정보관리책임자로 지정해 운영하고 있으며, 위치정보관리책임자의 성명과 연락처는 아래와 같습니다.
F.성명 : 홍성욱
G.대표전화 : 010-4739-0704
H.이메일주소 : contact@38do.kr
제14조 (양도금지)
...
C.회원의 귀책사유로 서비스 이용에 장애가 있는 경우
D.제1호 내지 제3호를 제외한 기타 회사의 고의ㆍ과실이 없는 사유로 인한 경우
...
부칙
제1조 (시행일) 본 약관은 2021년 06월 01일부터 시행합니다.
만약 사용자와 하이퍼로컬 간의 위치정보와 관련한 분쟁에 대하여 협의가 어려운 때에는 사용자은 위치정보의 보호 및 이용 등에 관한 법률 제 28조 2항 및 개인정보보호법 제43조의 규정에 따라 개인정보 분쟁조정위원회에 조정을 신청할 수 있습니다.
[1]위치기반서비스 특유의 서비스 중단 사유로, 이용약관과 중복되지 않는 범위 내에서 추가하였습니다.
[2]이용약관 ‘위치기반서비스 관련’ 란에 있는 서비스 내용으로, 이용약관에서는 삭제하고 본 약관에 추가하였습니다. 서비스 내용에 위 기재 내용이 추가됨으로, 아래 5. 위치정보 이용 목적에도 동일한 취지로 일부 내용 추가하였습니다
[3]위치 정보를 제3자에게 제공할 경우, 본문 또는 별도 링크 등을 활용하여 제공받은자, 제공목적, 제공정보를 기재하셔야 합니다.
[4]본문과 관계 없는 내용으로, 위 제11조 제2항과 중복됩니다. 오기로 보여 삭제하고 본문에 맞는 내용을 추가하였으니 확인 부탁드립니다.
                `}
            </pre>
        </div>
    )
